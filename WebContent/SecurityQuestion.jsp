					...
					<div class="col-md-6 col-md-offset-3 login_form_div">
						...
						<form action="LSPController" method="post" accept-charset="utf-8">
							...
							<div class="form-group">
								<label for="city" class="col-md-4 control-label"><i
									class="glyphicon glyphicon-ok-sign"></i>&nbsp;LabId</label>
								<div class="col-md-8">
							...
							<div class="form-group">
								<label for="city" class="col-md-4 control-label"><i
									class="glyphicon glyphicon-ok-sign"></i>&nbsp;Question</label>

								<div class="col-md-8">

									<input type="text" class="form-control" id="question"
										name="question" value="<%=request.getAttribute("ques")%>"
										readonly>
								</div>
							</div>
							<br>
							...
							<div class="form-group">
								<label for="city" class="col-md-4 control-label"><i
									class="glyphicon glyphicon-ok-sign"></i>&nbsp;Answer</label>
								<div class="col-md-8">
									<input type="text" class="form-control" id="answer"
										name="answer" value="" placeholder="Please enter your answer"
										required>
								</div>
							</div>
							<br> <br>
							...
							%><span
								style="color: red; font-size:20px;">&nbsp;invalid answer</span><br> <br>
						
							<div class="text-center">
								<a href="LoginPage.jsp" class="btn btn-primary"> <span
									class="glyphicon glyphicon-home"></span> Go Back & login again
								</a>
							</div>
							<%
								}
