...
<body id="body">
	...
	<!-- -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-  Header section =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- -->
	<%
		LabServices ls = (LabServices) request.getAttribute("ls");
	%>
					...
					<div class="col-md-6 col-md-offset-3 login_form_div">
						<form>
							<h3 class="text-success text-center">
								<span><img src="image/up.png" alt="Success"></img></span>&nbsp;&nbsp;Service
								Added | Successfully
							</h3>
							<div class="separator"></div>
							<br>
							<h4 class="text-warning text-center">
								&nbsp;&nbsp;TestName =<span class="text-success"> <%=ls.getTestName()%></span>
								and TestCode =<span class="text-success"> <%=ls.getTestCode()%></span>
							...
							<div class="text-center">
								...
								</a> <a href="LabService.jsp" class="btn btn-primary"> <span
									class="glyphicon glyphicon-plus-sign"></span>&nbsp;Add more Services
