...
String ls=(String)request.getAttribute("testcode");%>
	<!-- -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-  Header section =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- -->
				...
				<div class="row">
					...
					<form>
						<h3 class="text-success text-center">
							<span><img src="image/up.png" alt="Success"></img></span>&nbsp;&nbsp;Schedule Deleted
							| Successfully
						</h3>
						...
						<h4 class="text-success text-center">
							&nbsp;&nbsp; TestCode <%=ls%> deleted successfully
						</h4>
						<br>
						<br> <br>
						...
						<br>
						<%}else{%> Service not deleted <div class="text-center">
							<a href="LSPOption.jsp" class="btn btn-info"> <span
								class="glyphicon glyphicon-home"></span> Please Press Here for
								DashBoard
							</a>
