...
<body id="body">
	...
	<!-- -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-  Header section =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- -->
<%LabServiceProvider ls=(LabServiceProvider)request.getAttribute("lspobj");%> 
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3 login_form_div">
						...
						<h3 class="text-success text-center">
							<span><img src="image/up.png" alt="Success"></img></span>&nbsp;&nbsp;Correct Details
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" id="password"
										value="<%=ls.getPassword()%>" name="password" readonly>
								</div>
						...
						<div class="text-center">
							<a href="LoginPage.jsp" class="btn btn-info"> <span
