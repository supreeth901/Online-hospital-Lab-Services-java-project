...
<%LabServices ls=(LabServices)request.getAttribute("ls");%>
	...
	<h3 class="text-success text-center">
							<span><img src="image/up.png" alt="Success"></img></span>&nbsp;&nbsp;Service Updated
							| Successfully
						</h3>
										...
										<div class=" col-md-12">
											<table class="table table-user-information table-responsive">
												<tbody>
													...
													<tr>
														<td><strong>Test Desc </strong></td>
														<td> <%=ls.getTestDescription()%></td>
													</tr>
													<tr>
														<td><strong>Test Duration</strong></td>
														<td> <%=ls.getTestDuration() %></td>
													</tr>
													<tr>
														<td><strong>Test Cost</strong></td>
														<td> <%=ls.getTestCost() %></td>
													</tr>

													<tr>
													<tr>
														<td><strong>Lab At Home</strong></td>
														<td> <%=ls.getLabHome() %></td>
													</tr>
