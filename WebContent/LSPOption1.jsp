						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="password" class="form-control" id="old_pass"
							       ...
							       <span style="color: red" id="err"><img src='image/warning.png' width='18px' height='18px'/> Incorrect Password"</span>
							     <% } %>	
							</div>
							</div>
						</div>
				...
				<div class="bs-glyphicons">
					<ul class="bs-glyphicons-list link_black">
						...
						<li><a href="searchPage.jsp"><span
								...
								class="glyphicon-class"><span style="font-size: 20px;">Search
										Lab Services</span></span></a></li>
						...
						<li><a href="LabSchedule.jsp"><span class="glyphicon glyphicon-plus"
								aria-hidden="true"></span> <span class="glyphicon-class"><span
									style="font-size: 20px;">Create lab Schedule</span></span></a></li>

                         <li><a href="ViewSchedule.jsp"><span
								class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>
								<span class="glyphicon-class"><span
									style="font-size: 20px;">View Schedule</span></span></a></li>
	
						
						
						<li><a href="RegisterPage1.jsp"><span
								class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
								<span class="glyphicon-class"><span
