				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3 login_form_div">
						...
						<h3 class="text-danger text-center">
							<span><img src="image/warning.png" alt="Failed"></img></span>&nbsp;&nbsp;Registration
							| Failed
						</h3>
						...
						<h5 class="text-danger text-center">
							...
							<%=request.getAttribute("contactno") %> already exists&nbsp;<a href="RegisterPage.jsp"><span
								class="glyphicon glyphicon-pencil">Register</span></a> Again
						</h5>
						<br>
