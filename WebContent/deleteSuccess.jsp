...
String ls=(String)request.getAttribute("testname");%>
	<!-- -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-  Header section =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- -->
				...
				<div class="row">
					...
					<form>
						<h3 class="text-success text-center">
							<span><img src="image/up.png" alt="Success"></img></span>&nbsp;&nbsp;Service Deleted
							| Successfully
						</h3>
						...
						<h4 class="text-success text-center">
							&nbsp;&nbsp; TestName - <%=ls%> has been deleted successfully
						</h4>
						<br>
						<br> <br>
